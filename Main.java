...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("I've also overheard a fight occurring over operators not being able to divide food rations equally amongst themselves. Would you like to help sort it out?");
